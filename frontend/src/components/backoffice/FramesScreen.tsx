...
export const FramesScreen = () => {
  ...
  const [form, setForm] = useState<FramePayload>({ name: '', rows: 2, cols: 2, photoWidth: 200, photoHeight: 200, spacing: 8, description: '' });
  ...
  const handleSave = () => {
    ...
    setForm({ name: '', rows: 2, cols: 2, photoWidth: 200, photoHeight: 200, spacing: 8, description: '' });
    setEditingId(null);
    setShowForm(false);
  };
  ...
  const handleEdit = (f: any) => {
    setEditingId(f.id);
    setForm({ name: f.name, rows: f.rows, cols: f.cols, photoWidth: f.photoWidth, photoHeight: f.photoHeight, spacing: f.spacing, description: f.description });
    setShowForm(true);
  };
