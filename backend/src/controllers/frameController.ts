...
export const getFramesByProjectIdController = async (req: any, res: any) => {
  try {
...
export const addFrameToProjectController = async (req: any, res: any) => {
  try {
...
export const removeFrameFromProjectController = async (req: any, res: any) => {
  try {
