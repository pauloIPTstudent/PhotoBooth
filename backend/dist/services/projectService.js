...
export async function createProject(payload) {
    try {
        ...
        const styleFromBody = payload.style || {};
        const theme = payload.theme || styleFromBody.theme || 'default';
...
export async function updateProject(id, payload) {
    try {
        ...
        const now = new Date().toISOString();
        const styleFromBody = payload.style || {};
        const theme = payload.theme ?? styleFromBody.theme ?? existing.theme;
...
export async function getProjectStyle(id) {
    try {
